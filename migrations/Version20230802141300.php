 ...
 */
final class Version20230802141300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_952E12D740C1FEA7 ON asignature (year_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_952E12D740C1FEA7 ON asignature');
