 ...
 */
final class Version20230808231719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE student_asignature (student_id INT NOT NULL, asignature_id INT NOT NULL, INDEX IDX_78F1FF36CB944F1A (student_id), INDEX IDX_78F1FF364AA59B0C (asignature_id), PRIMARY KEY(student_id, asignature_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
